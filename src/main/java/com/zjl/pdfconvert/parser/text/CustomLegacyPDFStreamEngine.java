 ...
 */
public class CustomLegacyPDFStreamEngine extends PDFStreamEngine {
    private static final Log LOG = LogFactory.getLog(CustomLegacyPDFStreamEngine.class);
     ...
     * Constructor.
     */
    CustomLegacyPDFStreamEngine() throws IOException {
     ...
     */
    @Override
    public void showGlyph(Matrix textRenderingMatrix, PDFont font, int code, Vector displacement)
            throws IOException {
        //
